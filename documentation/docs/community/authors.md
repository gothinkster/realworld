...
James is a Software Engineer at Square and a contributor to the Django project. He created & currently maintains the RW Django codebase and continually provides guidance for the RealWorld project itself.
