...
Instead of having the Bootstrap theme included locally, we recommend loading the precompiled theme from our CDN (our [header template](/specifications/frontend/templates.md#header) does this by default):
