...
- There is a [hosted version](https://realworld-docs.netlify.app/specifications/frontend/api#demo-api) of the backend API available for public usage, no API keys are required
